...
TEST_PATH = '/Users/ksj/Desktop/sy/work/tensorflow-hangul-recognition-master'
SCRIPT_PATH = TEST_PATH + '/tools/hangul-image-generator.py'
...
class ImageGeneratorTestCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.fonts_dir = os.path.join(TEST_PATH, '/tests/test-fonts')
